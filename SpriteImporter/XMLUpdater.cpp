// XMLUpdater.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main() {
    ...
    const string soundsDir = "../Media/Sounds/";

    //tryin find bug
    
    cout << "XML Path: " << xmlPath << endl;
    cout << "Images Directory" << imagesDir << endl;
    cout << "Sounds Directory" << soundsDir << endl;
